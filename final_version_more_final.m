%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Script to produce heatmaps for MWM data and perform analysis of 
%%% swimming strategy.
%%% Originally btained from the Kempermann lab by Jake Rogers.
%%% Modified by Ariel Zeleznikow-Johnston to work with the setup at the
%%% Florey.
%%% Last modified December 2015
%%% Used for figures in: https://doi.org/10.1038/tp.2016.52
%%
clear all
...
hippocampal=zeros(1,length(filetoanalyse));
hippocampalcheck=zeros(1,length(filetoanalyse));
...
% h=figure('Position',[50 50 600 300],'visible','off');
...
results.hippocampal(1,f)=hippocampal(1,f);
...
xlswrite(strategy_summary,xl_C,'C1:C1');
xlswrite(strategy_summary,results.fileNumber','A2:A9999');
xlswrite(strategy_summary,results.strats','B2:B9999');
xlswrite(strategy_summary,results.hippocampal','C2:C9999');